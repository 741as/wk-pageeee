...
function getVLESSConfig(userID, hostName) {
    const vlessLink = `vless://${userID}@i.jk.al:80?encryption=none&security=none&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2048#CF-wk-pagee`
    const vlessTlsLink = `vless://${userID}@4.42.ar:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2048#CF-wk-pagee-tls`
    return `
