...
let userID = 'ecaaf79b-30c9-48f2-a3eb-9dfb6b918a3f';
...
function getVLESSConfig(userID, hostName) {
    const vlessLink = `vless://${userID}@i.jk.al:80?encryption=none&security=none&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2048#Misaka-workers`
    const vlessTlsLink = `vless://${userID}@4.42.ar:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2048#Misaka-workers-TLS`
    return `
